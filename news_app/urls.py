...
urlpatterns = [
    ...
    path('<slug:slug_category>/<slug:slug_article>/dislike_article', views.dislike_article, name='dislikes_article'),
    path('<slug:slug_category>/<slug:slug_article>/add_favorite_art', views.add_favorite_article,
         name='add_favorite_art'),
    path('<slug:slug_category>/<slug:slug_article>/add_word', views.add_word_to_dictionary,
