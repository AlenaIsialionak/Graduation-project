...
class Translation(models.Model):
    ...
    word = models.ForeignKey(Dictionary, on_delete=models.CASCADE, related_name='translations')
    language = models.ForeignKey(Language, on_delete=models.CASCADE, related_name='language_translate')

    def __str__(self):
        return self.translation

class Test(models.Model):
    word = models.OneToOneField(Dictionary, on_delete=models.CASCADE, related_name='test')
